...
@Disabled
public class Strafe_Test extends OpMode {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 0:
                ...
                if (angleDrive(24, .2, Math.PI/2, 0)) {
                    this.nextState();
                }
                break;
            ...
            case 2:
                if (angleDrive(24, .2, Math.PI/2, -90)) {
                    this.nextState();
                }
                break;
            ...
            case 4:
                if (angleDrive(24, .2, Math.PI/2, -180)) {
                    this.nextState();
                }
                break;
            ...
            case 6:
                if (angleDrive(24, .2, Math.PI/2, -270)) {
                    this.nextState();
                }
                break;
            ...
            case 7:
                if (runtime.time() < 1) {
                    flopperClamp.setPosition(.7);
                    flopperDick.setPosition(.68);
                    this.nextState();
                }
                break;
