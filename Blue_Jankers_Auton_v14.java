 ...
 */
@Autonomous(name="Test 4 blue",group="Auton")
@Disabled
public class Blue_Jankers_Auton_v14 extends OpMode {
    ...
    static final double ALIGN_ARM_LOWERED                           = .42;
        ...
        switch (state) {
            ...
            case 2:
                ...
                if (ALLIANCE_COLOR.equals("Red")){
                    ...
                    if (encoderIMUdrive(distance, .7, 0)) {
                        fastNextState();//state++;
                    }
                }
