 ...
 */
@Autonomous(name="Suck Test w/ Voltage Sensing",group="Auton")
@Disabled
public class Suck_Test_v5 extends OpMode {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 1:
                if(PIDdrive(-(encoderCount/COUNTS_PER_INCH), -.7)){
                    this.nextState();
                }
