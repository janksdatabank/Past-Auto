 ...
 */
@Autonomous(name="Voltage Test",group="Auton")
@Disabled
public class Voltage_Test extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Voltage: ", vs.getVoltage());
        telemetry.addData("Min Voltage: ", minV);
        telemetry.addData("Max Voltage: ", maxV);
        telemetry.addData("Voltage Dif: ", minV-vs.getVoltage());
        telemetry.addData("Block Count: ", blockCount);
        telemetry.addData("Drop Voltage: ", dropV);
        ...
        switch (state) {
            ...
            case 0:
                ...
                // Spin up the motors, wait for the voltage to stabilize before pulling values, run forward until a voltage drop occurs
                // Allows for a small delay before checking if the block was sucked in
                if(runtime.time() < 1) {
