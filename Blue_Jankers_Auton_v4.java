 ...
 */
@Autonomous(name="Column Distance Alignment Test",group="Auton")
@Disabled
public class Blue_Jankers_Auton_v4 extends OpMode {
    ...
    public void init() {
        ...
        flopperDick.setPosition(.25);
        flopperClamp.setPosition(.75);
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            // Extend the color sensor, read the color, initiate knocking the corresponding jewel
            case 1:
            ...
            // Wait for the servo to hit the jewel
            case 2:
                if (runtime.time() < .5) {
                    if (measuredColor.equals("Red")){
            ...
            case 9:
                if (this.PIDdrive(5, .2)) {
                    flopperClamp.setPosition(.55);
                    flopperDick.setPosition(.25);
                    this.resetEncoder();
