 ...
 */
@Autonomous(name="Other Balancing Stone Blue Side",group="Auton")
@Disabled
public class Blue_Jankers_Auton_v9 extends OpMode {
    ...
    static final double STRAFE_DIST_LEFT_RED                            = (6+3.75);                // The distance when strafing from the left to center column
    static final double STRAFE_DIST_CENTER_RED                          = 6;
    static final double STRAFE_DIST_RIGHT_RED                           = (6 - 3.75);
