 ...
 */
@Autonomous(name="Red_Gas",group="Auton")
@Disabled
public class Red_Gas extends OpMode {

    //* Everything before next comment is defining variables to be accessed
    //* for the the rest of the time

    static final double COUNTS_PER_MOTOR_REV = 1075.2;//1120;
    static final double DRIVE_GEAR_REDUCTION = 1;
    static final double WHEEL_DIAMETER_INCHES = 3.937;//5.25;
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 15:
                ...
                if (PIDdrive(5, FAST_DRIVE_SPEED)){
