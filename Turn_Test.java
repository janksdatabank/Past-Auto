 ...
 */
@Autonomous(name="PID Tuning/Turn Testing",group="Auton")
@Disabled
public class Turn_Test extends OpMode {
    ...
    static final double I_C = 0.00025;
    ...
    static final double STRAFE_DIST_LEFT_CENTER                     = 6;                // The distance when strafing from the left to center column
    static final double STRAFE_DIST_LEFT_RIGHT                      = 12;
    static final double STRAFE_DIST_CENTER_LEFT                     = -6;
    static final double STRAFE_DIST_CENTER_RIGHT                    = 6;
    static final double STRAFE_DIST_RIGHT_CENTER                    = -6;
    static final double STRAFE_DIST_RIGHT_LEFT                      = -12;
    ...
    public boolean turn(int angleTarget) {
        ...
        if ((Math.abs(angleError) > HEADING_THRESHOLD)) {
            ...
            drivePower = (angleError * P_C) + (iError * I_C) + (dError*D_C);
