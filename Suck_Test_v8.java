 ...
 */
@Autonomous(name="Suck Test w/ Updated Alg & Voltage Sensing",group="Auton")
@Disabled
public class Suck_Test_v8 extends OpMode {
    ...
    static final double RIGHT_COL_DIST_BLUE                         = 23 + 4;
    static final double LEFT_COL_DIST_BLUE                          = 23 - 5.25;
    static final double ANGLE_OF_BOX_BLUE                           = -90;              // Angle to face the blue cryptobox
    static final double CENTER_COL_DIST_RED                         = -23;
    static final double RIGHT_COL_DIST_RED                          = -(23 - 5.25);
    static final double LEFT_COL_DIST_RED                           = -(23 + 4);
    ...
    static final double GLYPH_DUMP_LOWERED                          = .475;
    ...
    public void loop() {
        ...
        switch (state) {
                    ...
                    if (blockCount != 2) {
                        if (!block) {
                            ...
                            if (runtime.time() < checkDelay){
                                ...
                                if (bDist.getDistance(DistanceUnit.CM) < 70){
                                    sucked = true;
                                }
            ...
            case 2:
                rightIntake.setPower(0);
                leftIntake.setPower(0);
                if(encoderIMUdrive((-encoderCount/COUNTS_PER_INCH), -FAST_DRIVE_SPEED, 0)){
                    nextState();
                }
                break;
