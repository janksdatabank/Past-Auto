 ...
 */
@Autonomous(name="Updated Suck Test",group="Auton")
@Disabled
public class Suck_Test_v6 extends OpMode {
        ...
        switch (state) {
            ...
            case 0:
                ...
                if (runtime.time() < .5) {
                    ...
                    rearRightMotor.setPower(-.4);
                    rearLeftMotor.setPower(.4);
                } else if (runtime.time() < 3) {
                    frontRightMotor.setPower(.4);
                    frontLeftMotor.setPower(-.4);
                    rearRightMotor.setPower(.4);
                    rearLeftMotor.setPower(-.4);
                } else if (runtime.time() < 3.5) {
