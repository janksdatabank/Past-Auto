 ...
 */
@Autonomous(name="Suck Test w/ Strafe",group="Auton")
@Disabled
public class Suck_Test_v4 extends OpMode {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 0:
                ...
                if(this.PIDdrive(12, 1)){
                    this.nextState();
                }
                break;

            case 1:
                if(this.PIDdrive(-4, -.2)){
                    this.nextState();
            ...
            case 2:
                if(this.angleDrive(4, .5, Math.PI/2, currentHeading)){
                    this.nextState();
                }
