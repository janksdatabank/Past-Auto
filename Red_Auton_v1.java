...
@Disabled
public class Red_Auton_v1 extends OpMode {
    ...
    static final double P_C_EI = 0.05;
    ...
    static final double LEFT_COL_DIST_BLUE                          = 23 - 5;
        ...
        switch (state) {
            ...
            case 8:
                if(!atWall) {
                    ...
                    if(aDist.getDistance(DistanceUnit.CM) > 8.5 && runtime.time() > checkDelay){
                        angleDrive(.1, STRAFE_RIGHT, boxAngle);
                        RobotLog.ii("OUTPUT_INFO", "Strafe Right");
                        //telemetry.addData("Strafing: ", "Left");
                    } else if (aDist.getDistance(DistanceUnit.CM) < 6 && runtime.time() > checkDelay){
