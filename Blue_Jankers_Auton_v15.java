 ...
 */
@Autonomous(name="Sergeant Doakes",group="Auton")
@Disabled
public class Blue_Jankers_Auton_v15 extends OpMode {
       ...
       // telemetry.addData("Direction", strafeDir);
        ...
        switch (state) {
            ...
            case 11:
                ...
                if (encoderIMUdrive(REVERSE_TO_PIT_DIST + 2, FAST_DRIVE_SPEED, boxAngle)) {
                    fastNextState();
                }
                break;
                ...
                if(runtime.time() < .25) {
                    ...
                    if (blockCount != 2) {
                        if (!block) {
                            ...
                            if (fDist.getDistance(DistanceUnit.CM) < 7 &&
                                    bDist.getDistance(DistanceUnit.CM) < 7){
                                sucked = true;
                            }
            ...
            case 14:
                ...
                if (encoderIMUdrive(-((encoderCount+5)/COUNTS_PER_INCH), -FAST_DRIVE_SPEED, boxAngle)) {
                    goToState(4
                    );
                }
                break;
            ...
            case 15:
                ...
                if (PIDdrive(1, FAST_DRIVE_SPEED)){
